...
const WhatsAppConfig = () => {
  const [status, setStatus] = useState("LOADING"); // LOADING, QR_READY, CONNECTED
            ...
            {status === "QR_READY" && (
              <div>
                ...
                <p className="mt-3 text-warning">
                  <i className="fas fa-exclamation-triangle"></i> El código se
                ...
                <button
                  ...
                  onClick={() =>
                    Swal.fire(
                      ...
                      "Próximamente podrás cerrar sesión desde aquí",
                      "info"
                    )
                  }
                >
