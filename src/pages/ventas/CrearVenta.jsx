...
//   // 🚀 ESTADOS PARA EL CONSULTADOR DE PRECIOS 🚀
...
//   useEffect(() => {
//     const handleKeyDown = (e) => {
//       // 🚀 ATAJO CTRL + F9 PARA CONSULTADOR 🚀
...
//           </div>
//           <div className="col-sm-6 text-right">
//             <span className="badge badge-info p-2 ml-1">
//               CTRL+F9: Consultar
//             </span>
//             <span className="badge badge-secondary p-2 ml-1">
//               F3: Listado Ventas
...
//       {/* 🚀 MODAL CONSULTADOR DE PRECIOS (SHIFT + F9) 🚀 */}
...
//                   Busque por código o nombre del producto
//                 </label>
...
//                     onChange={(e) => {
//                       setBusquedaConsulta(e.target.value);
...
//                       );
//                       if (e.target.value.length > 2) setProductoConsultado(p);
//                       else setProductoConsultado(null);
//                     }}
//                   />
//                 </div>
//               </div>
...
//               {productoConsultado ? (
//                 <div className="card mt-4 animate__animated animate__fadeIn shadow-none border">
//                   <div className="card-body text-center">
//                     <h3 className="text-bold text-navy mb-0">
//                       {productoConsultado.nombre}
//                     </h3>
//                     <p className="text-muted small mb-3">
//                       Cód: {productoConsultado.codigo}
//                     </p>
//                     <div
...
//                         <h4
//                           className={`font-weight-bold ${productoConsultado.stock <= productoConsultado.stock_minimo ? "text-danger" : "text-primary"}`}
//                         >
//                           {productoConsultado.stock} unidades
//                         </h4>
//                       </div>
//                       <div className="col-6">
//                         <span className="text-muted small d-block">COSTO</span>
//                         <h4 className="text-dark font-weight-bold">
//                           {formatMoney(productoConsultado.precio_compra)}
//                         </h4>
//                       </div>
//                     </div>
//                   </div>
...
//                   <p>Aguardando ingreso de código o nombre...</p>
//                 </div>
//               )}
//             </div>
//             <div
