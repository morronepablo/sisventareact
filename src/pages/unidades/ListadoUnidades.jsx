...
const ListadoUnidades = () => {
    ...
    if (!loading) {
      const timer = setTimeout(() => {
        ...
        window.$(tableId).DataTable({
          ...
          lengthChange: false, // Usamos el control manual superior
          searching: false, // Usamos el control manual superior
          dom: "rtip", // Oculta duplicados automáticos
      ...
      return () => {
        ...
        if (window.$) {
          ...
          if (window.$.fn.DataTable.isDataTable("#unidades-table")) {
            window.$("#unidades-table").DataTable().destroy();
          }
        }
      };
    }
  ...
  const handleEliminar = async (id, nombre) => {
    const result = await Swal.fire({
      title: "¿Estás seguro?",
      text: `¡Vas a eliminar la unidad "${nombre}"!`,
      icon: "warning",
      ...
      <div className="container-fluid">
        <div className="card card-outline card-primary shadow-sm">
          ...
          <div className="card-body">
            {/* Barra de controles manuales (Mostrar, Botones, Buscar) */}
              ...
              <tbody>
                {unidades.map((u, i) => (
                  <tr key={u.id}>
                    ...
                    <td className="align-middle">{u.nombre}</td>
