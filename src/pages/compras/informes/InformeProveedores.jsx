// src/pages/compras/informes/InformeProveedores.jsx
...
const InformeProveedores = () => {
  ...
  const handleGenerar = () => {
    navigate(
      `/compras/informes/proveedores/detalle?desde=${fechas.inicio}&hasta=${fechas.fin}`
    );
  };
  ...
  return (
    <div className="content-header">
      <div className="container-fluid">
        <h1>
          <b>Informe de Compras por Proveedor</b>
        </h1>
        <hr />
