// src/pages/compras/informes/InformeNoPagadas.jsx
import React, { useState } from "react";
import { useNavigate } from "react-router-dom";

const InformeNoPagadas = () => {
  ...
  const handleGenerar = () => {
    navigate(
      `/compras/informes/no-pagadas/detalle?desde=${fechas.inicio}&hasta=${fechas.fin}`
    );
  };
  ...
  return (
    <div className="content-header">
      <div className="container-fluid">
        <h1>
          <b>Informe de Compras no Pagadas</b>
        </h1>
        <hr />
...
export default InformeNoPagadas;
